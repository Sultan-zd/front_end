...
const SubmissionConfirmation3 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#b0b0b0] to-[#a1a1a1] flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-xl w-4/5 max-w-2xl">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#8c8c8c] to-[#d1d1d1] mb-6">
        ...
        {/* Decorative Divider */}
        <div className="my-8 border-t-2 border-[#d1d1d1]"></div>

        {/* Next Steps */}
        <div className="text-center">
          <h2 className="text-2xl font-semibold text-[#a1a1a1] mb-4">What’s Next?</h2>
        ...
        <div className="mt-8 text-center">
          <h2 className="text-2xl font-semibold text-[#a1a1a1] mb-4">Complete Your Payment</h2>
          ...
          <button
            className="bg-[#b0b0b0] text-black font-semibold text-lg px-6 py-3 rounded-lg shadow-md hover:bg-[#9e9e9e] transition duration-300"
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-center gap-4">
          <button
            className="bg-[#6c757d] text-white font-semibold text-lg px-6 py-3 rounded-lg shadow-md hover:bg-[#5a636a] transition duration-300"
