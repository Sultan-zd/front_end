...
const PlatinumCertificateConfirmation = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#b0b8c1] to-[#8e99a2] flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-xl w-4/5 max-w-2xl">
        ...
        {/* Next Steps */}
        <div className="text-center">
          <h2 className="text-2xl font-semibold text-[#7a7c7e] mb-4">What’s Next?</h2>
        ...
        <div className="mt-8 text-center">
          <h2 className="text-2xl font-semibold text-[#7a7c7e] mb-4">Complete Your Payment</h2>
...
export default PlatinumCertificateConfirmation;
