...
const TrackPlatinumApplication = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#b0b8c1] to-[#8e99a2] flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-xl w-4/5 max-w-lg">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#9a9c9e] to-[#7a7c7e] mb-6">
            Track Your Platinum Certificate Application
          </h1>
          <p className="text-lg text-gray-700 mb-4">
            Enter your application ID to check the status of your Platinum Certificate request.
          </p>
        </div>
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8e99a2] transition duration-300"
          />
        </div>
        ...
        <div className="flex justify-center mb-6">
          <button
            className="bg-[#8e99a2] text-white font-semibold text-lg px-6 py-3 rounded-lg shadow-md hover:bg-[#7a7c7e] transition duration-300"
            onClick={() => {
                navigate("/application-status2");
              }}
          >
...
export default TrackPlatinumApplication;
